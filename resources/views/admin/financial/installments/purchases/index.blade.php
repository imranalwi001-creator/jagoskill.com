                            ...
                            <div class="table-responsive">
                                <table class="table table-striped font-14">
                                    <tr>
                                        ...
                                        <th class="text-center">{{ trans('update.upcoming_date') }}</th>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    @if(!empty($order->upcoming_date))
                                                        <span class="d-block">{{ $order->upcoming_date }}</span>
                                                        <span class="d-block font-12 text-muted">{{ trans('update.days_left', ['days' => $order->days_left]) }}</span>
                                                    @else
                                                        -
                                                    @endif
                                                </td>
