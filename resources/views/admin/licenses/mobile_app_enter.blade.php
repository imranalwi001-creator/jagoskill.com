    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Enter Mobile App License</div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="mb-0" action="{{ route('admin.mobile_app.license.store') }}" method="post">
                                @csrf
                                
                                @if(session()->has('mobile_app_error'))
                                    <div class="alert-custom rounded-16 text-danger bg-danger-20 mt-0 mb-3 d-flex align-items-center" role="alert">
                                       <x-iconsax-bul-info-circle class="icons text-danger mr-4" width="24px" height="24px"/>
                                        {{ session()->get('mobile_app_error') }}
                                        
                                        @if(session()->has('mobile_app_registered_domain'))
                                            <div class="mt-2">
                                                <strong>Registered Domain:</strong> {{ session()->get('mobile_app_registered_domain') }}
                                            </div>
                                        @endif
                                    </div>
                                @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                           ...
                                           class="form-control custom-input @error('purchase_code') is-invalid @enderror"
                    ...
                    <div class="card rounded-24">
                         ...
                         <div class="info-card-body rounded-24">
                            ...
                            <div class="mt-4">
                                 ...
                                 <div class="feature-item rounded-16 border-gray-300">
                                    <div class="feature-icon bg-primary-30 text-primary">
                                      <x-iconsax-bul-mobile class="icons text-primary" width="24px" height="24px"/>
                                    </div>
                            ...
                            <div class="alert-custom bg-warning-20">
                                ...
                                <p class="text-warning">Each purchase code is valid for a single domain only. If you want to use the Mobile App on multiple domains or installations, you must obtain a separate license for each one.</p>
                            </div>
