    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Theme Builder License</div>
            </div>
        </div>
                ...
                <div class="col-12 col-lg-5">
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h4>Enter Theme Builder License</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.theme-builder.license.store') }}" method="post">
                                @csrf
                                
                                @if(session('theme_builder_error'))
                                   <div class="alert-custom rounded-16 text-danger bg-danger-20 mt-0 mb-3  d-flex align-items-center" role="alert">
                                       <x-iconsax-bul-info-circle class="icons text-danger mr-4" width="24px" height="24px"/>
                                        {{ session('theme_builder_error') }}
                                    </div>
                                @endif

                                <div class="form-group">
                                    <label class="input-label font-weight-500 font-14">Purchase Code</label>
                            ...
                            <div class="mt-4">
                                <div class="feature-item rounded-16 border-gray-300">
                                    ...
                                    <div class="feature-content">
                                        <h5>Theme & Landing Builder</h5>
                                        <p class="text-gray-500">Create beautiful, responsive landing pages and customize your LMS theme with our powerful drag-and-drop builder.</p>
                                    </div>
                                </div>
