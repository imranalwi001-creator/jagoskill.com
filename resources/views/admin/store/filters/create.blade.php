    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active"><a href="{{ getAdminPanelUrl() }}/store/filters">{{ trans('admin/main.filters') }}</a></div>
        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12 col-md-6 col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ getAdminPanelUrl() }}/store/filters/{{ !empty($filter) ? $filter->id.'/update' : 'store' }}" method="Post">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('category_id') is-invalid @enderror" name="category_id">
                                        <option {{ empty($filter) ? 'selected' : '' }} disabled>{{ trans('admin/main.choose_category') }}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ !empty($filter) ? $filter->title : old('title') }}" placeholder="{{ trans('admin/main.choose_title') }}"/>
                                    @error('title')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                            ...
                                            @foreach($filterOptions as $key => $filterOption)
                                                <li class="form-group list-group rounded-lg p-2 mb-3 position-relative">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="sub_filters[{{ $filterOption->id }}][title]" class="form-control w-auto flex-grow-1" value="{{ $filterOption->title }}" placeholder="{{ trans('admin/main.choose_title') }}"/>
                                                        <div class="input-group-append">
                                                            @include('admin.includes.delete_button',[
                                                                'url' => getAdminPanelUrl("/store/filters/options/{$filterOption->id}/delete"),
                            ...
                            <li class="form-group main-row list-group rounded-lg p-2 mb-3 position-relative d-none">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="sub_filters[record][title]" class="form-control w-auto flex-grow-1" placeholder="{{ trans('admin/main.choose_title') }}"/>
                                    <div class="input-group-append">
