        ...
        <div class="section-body">
            <div class="row">
                            ...
                            <form action="{{ getAdminPanelUrl() }}/store/top-categories/{{ !empty($editFeaturedCategory) ? $editFeaturedCategory->id.'/update' : 'store' }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="image" id="image" value="{{ !empty($editFeaturedCategory) ? $editFeaturedCategory->image : old('image') }}" class="form-control @error('image') is-invalid @enderror" placeholder="{{ trans('admin/main.image') }}"/>
                                        @error('image')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                ...
                <div class="col-12 col-md-7">
                    <div class="card">
                        <div class="card-header">
                            <h4>{{ trans('update.top_categories') }}</h4>
                        </div>
                                    ...
                                    @if(!empty($featuredCategories))
                                        @foreach($featuredCategories as $featuredCategory)
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ $featuredCategory->image }}" width="40" height="40" alt="">
                                                </td>
                                                <td>
                                                    <div class="btn-group dropdown table-actions position-relative">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a href="{{ getAdminPanelUrl() }}/store/top-categories/{{ $featuredCategory->id }}/edit" class="dropdown-item">{{ trans('admin/main.edit') }}</a>
                                                            <a href="{{ getAdminPanelUrl() }}/store/top-categories/{{ $featuredCategory->id }}/delete" class="dropdown-item text-danger delete-action" data-confirm-text="{{ trans('public.confirm_delete') }}">{{ trans('admin/main.delete') }}</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
