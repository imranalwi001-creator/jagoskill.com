        ...
        <div class="d-flex align-items-center gap-8">
            ...
            @foreach($getUserLanguageAndLocale as $localeSign => $language)
                @if(mb_strtolower(app()->getLocale()) == mb_strtolower($localeSign))
                    <div class="js-mobile-header-show-specific-drawer d-flex-center size-32 bg-gray-100 rounded-8 font-11 font-weight-bold text-primary text-uppercase" data-drawer="language">
