...
Route::group(['middleware' => 'api.auth'], function () {
    ...
    Route::group(['prefix' => 'payments'], function () {
        ...
        Route::get('/verify/{gateway}', ['as' => 'api.payment_verify', 'uses' => 'PaymentController@paymentVerify']);
        Route::post('/verify/{gateway}', ['as' => 'api.payment_verify_post', 'uses' => 'PaymentController@paymentVerify']);
    });
    ...
    Route::group(['prefix' => 'webinars'], function () {
        ...
        Route::group(['prefix' => '/personal-notes'], function () {
            Route::get('/', 'CoursePersonalNotesController@show');
            Route::post('/', 'CoursePersonalNotesController@store');
...
Route::group([], function () {
    ...
    Route::get('/assignments/{assignment}', ['uses' => 'WebinarAssignmentController@show'])->name('webinar_assignment.show');
